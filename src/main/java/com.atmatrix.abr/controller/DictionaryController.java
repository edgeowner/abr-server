...
public class DictionaryController {
    ...
    @ApiOperation(value = "获取行政区", notes = "获取行政区")
    ...
    @ApiOperation(value = "获取计费模式及价格", notes = "获取计费模式及价格")
    ...
    @ApiOperation(value = "获取出租状态", notes = "获取出租状态")
